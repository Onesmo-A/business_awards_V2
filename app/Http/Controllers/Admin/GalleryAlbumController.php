...
class GalleryAlbumController extends Controller
{
    ...
    public function edit(GalleryAlbum $galleryAlbum)
    {
        ...
        // REKEBISHO: Tumia route ya 'storage.file' badala ya Storage::url() kwa sababu hatutumii symlinks
        $galleryAlbum->cover_image_url = $galleryAlbum->cover_image ? route('storage.file', ['path' => 'storage/' . $galleryAlbum->cover_image]) : null;
