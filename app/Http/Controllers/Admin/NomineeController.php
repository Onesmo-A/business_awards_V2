...
class NomineeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $availableYears = SeasonAward::orderBy('year', 'desc')->pluck('year');
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'year' => 'required|integer', // Hakikisha mwaka unatumwa
            'bio' => 'nullable|string',
            ...
            'source_application_id' => 'nullable', // Legeza kidogo validation hii au hakikisha ID inatumwa sahihi
        ]);
        ...
        Nominee::create([
            ...
            'year' => $validated['year'], // Hifadhi mwaka
            'bio' => $validated['bio'],
    ...
    public function edit(Nominee $nominee)
    {
        ...
        return Inertia::render('Admin/Nominees/Edit', [
            'nominee' => $nominee,
            'categories' => Category::where('year', $nominee->year)->orderBy('name')->get(['id', 'name']),
        ]);
    }
