...
class SettingController extends Controller
{
    public function index()
    {
        ...
        $defaults = [
            ...
            'application_support_phone' => '+255 652 724 557',
            'marathon_fee' => '35000',
            ...
            'timeline_step3_title' => 'Nomination',
    ...
    public function update(Request $request)
    {
        $validated = $request->validate([
            ...
            'allow_online_applications' => 'required|boolean',
            'application_support_phone' => 'nullable|string|max:255',
