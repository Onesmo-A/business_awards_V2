...
class TicketPaymentCompleted extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            from: new Address('noreply@businessawards.co.tz', 'Business Awards'),
            subject: 'Tiketi Zako za Business Awards Ziko Tayari!',
        );
    }
    ...
    public function attachments(): array
    {
        ...
        return [
            Attachment::fromData(fn () => $pdf->output(), 'business-Awards-Tickets.pdf')
