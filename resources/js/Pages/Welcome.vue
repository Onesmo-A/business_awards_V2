...
import MarathonCTASection from '@/Components/Sections/MarathonCTASection.vue'; 
...
defineProps({
  ...
  sponsors: Object, // BORESHO: Ongeza sponsors prop
  mapSection: Object, // BORESHO: Ongeza mapSection prop
});
</script>
<template>
  <Head>
    ...
    <meta property="og:url" content="https://businessawards.co.tz/" />
    <meta property="og:title" :content="title" />
    <meta property="og:description" :content="description" />
    <meta property="og:image" content="https://businessawards.co.tz/images/logo.png" />

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image" />
    <meta property="twitter:title" :content="title" />
    <meta property="twitter:description" :content="description" />
    <meta property="twitter:image" content="https://businessawards.co.tz/images/logo.png" />
  </Head>

  <!-- GLOBAL WRAPPER: Lazimisha background nyeusi na maandishi meupe kwa ukurasa mzima -->
  <main class="selection:bg-[#D4AF37] selection:text-black bg-[var(--background-main)] min-h-screen text-text-primary overflow-x-hidden">
    <!-- NEW: pitisha slides -->
