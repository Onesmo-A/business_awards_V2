...
<template>
    <DefaultLayout>
        ...
        <!-- BORESHO: Imeongezwa pt-28 (padding-top) ili kusukuma maudhui yote chini ya header kuu -->
                 <div class="bg-background-main pt-28 min-h-screen">
            <PageHeader :title="category.name" />
            
            <div class="pb-12 lg:pb-16">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="text-center mt-8 mb-12 px-4">
                        <p class="text-base text-gray-300 max-w-3xl mx-auto">{{ category.description }}</p>
                    ...
                    <div v-else class="text-center py-16 bg-gray-900/50 rounded-lg border border-gray-800">
                        <p class="text-gray-400 text-xl">No nominees found in this category.</p>
                        <Link :href="route('home')" class="mt-4 inline-block text-yellow-500 hover:text-yellow-400 transition">
                            &larr; Back to Home
                        </Link>
                    </div>
                </div>
