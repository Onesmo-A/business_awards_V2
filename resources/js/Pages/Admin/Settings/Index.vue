...
const form = useForm({
    allow_online_applications: props.settings.allow_online_applications === '1' || props.settings.allow_online_applications === true,
    application_support_phone: props.settings.application_support_phone || '+255 652 724 557',
    ...
    <AdminLayout>
        ...
        <div class="max-w-4xl mx-auto bg-gray-800/50 border border-gold-500/10 shadow-2xl overflow-hidden sm:rounded-2xl p-6">
            <form @submit.prevent="updateSettings">
                <!-- Voting Section -->
                <h3 class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">Voting & Results Settings</h3>
                <div class="space-y-6">
                ...
                <div class="space-y-6">
                    <!-- Allow Online Applications Toggle -->
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="font-semibold text-gray-700 dark:text-gray-200">Allow Online Applications</p>
                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                Enable or disable the ability for users to submit applications online.
                            </p>
                        </div>
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" v-model="form.allow_online_applications" class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-purple-300 dark:peer-focus:ring-purple-800 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-purple-600"></div>
                        </label>
                    </div>

                    <div>
                        <InputLabel for="application_support_phone" value="Application Support Phone" class="dark:text-gray-300" />
                        <TextInput id="application_support_phone" v-model="form.application_support_phone" type="text" class="mt-1 block w-full" placeholder="+255 652 724 557" />
                        <InputError :message="form.errors.application_support_phone" class="mt-2" />
                    </div>
