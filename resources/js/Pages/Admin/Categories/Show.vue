...
watch(selectedYear, (newYear) => {
  router.get(route('admin.categories.show', props.category.id), { year: newYear }, {
    preserveState: true,
    preserveScroll: true,
  });
});
  ...
  <div class="p-6 text-gray-100">
    <div class="flex justify-between items-center mb-6">
      <div>
        ...
        <p class="text-gray-400 mt-1">{{ category.description }} ({{ selectedYear }})</p>
      </div>
    ...
    <div class="mb-6 w-full md:w-1/4">
      <label for="year-select" class="block text-sm font-medium text-gray-400 mb-1">Select Season</label>
