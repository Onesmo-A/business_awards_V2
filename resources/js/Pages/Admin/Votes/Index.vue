...
// BORESHO: Ongeza computed property kwa ajili ya URL ya ku-export summary
const exportSummaryUrl = computed(() => {
  ...
  <div class="p-6 text-gray-100">
    <div class="flex justify-between items-center mb-6">
      ...
      <div class="flex items-center space-x-2 md:space-x-3">
        ...
        <a :href="exportSummaryUrl"
          class="inline-flex items-center justify-center p-2 md:px-4 md:py-2 bg-yellow-600 hover:bg-yellow-700 text-white font-bold rounded-lg transition text-sm"
          title="Export Summary PDF"
          target="_blank"
        >
          <ExportIcon />
          <span class="hidden md:inline ml-2">Export Summary</span>
        </a>
      </div>
    </div>
    ...
    <div class="mb-6 p-4 bg-gray-800/50 rounded-lg">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div>
                <label for="year" class="block text-sm font-medium text-gray-400 mb-1">Season</label>
                <select
                    id="year"
