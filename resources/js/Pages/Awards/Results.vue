            ...
            <main class="pb-16 sm:pb-24">
                <div class="mx-auto max-w-4xl px-6 lg:px-8">
                    ...
                    <div v-else class="text-center py-16 bg-gray-900/50 rounded-lg border border-gray-700">
                        <h2 class="text-2xl font-bold text-white">Results Not Yet Announced</h2>
                        <p class="mt-2 text-gray-400">
                            The voting results for this category are not yet public.
                            <br>
                    ...
                    <div class="mt-16 text-center">
                        <Link :href="route('awards.seasons.show', year)" class="text-yellow-500 hover:text-yellow-300 font-semibold inline-flex items-center transition-colors">
                            <span class="mr-2">&larr;</span> Back to {{ year }} Winners
                        </Link>
                    </div>
                </div>
            </main>
