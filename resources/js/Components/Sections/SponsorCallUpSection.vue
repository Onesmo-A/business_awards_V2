  ...
  >
    ...
    <div class="relative z-10 container mx-auto px-6 lg:px-8 text-center">
      <h2 class="text-3xl font-bold tracking-tight text-accent sm:text-4xl drop-shadow-title">
        Help Recognize Outstanding Business Leaders
      </h2>
      <p class="mt-6 text-lg leading-8 text-text-secondary max-w-3xl mx-auto">
        Join us in celebrating and honoring exceptional business leaders, companies, and organizations in Tanzania. Your sponsorship will make this landmark event possible, connect you with industry leaders and stakeholders, and give your brand prestigious visibility aligned with excellence and impact.
      </p>
      <div class="mt-10 flex items-center justify-center">
        <Link href="/sponsorship" class="btn-primary"> Learn About Sponsorship </Link>
      </div>
    </div>
  </section>
</template>