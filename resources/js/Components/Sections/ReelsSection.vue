    ...
    <div v-if="reels && reels.length > 0" class="bg-gray-900 py-12 sm:py-16">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Release and Instagram Posts</h2>
                <p class="mt-2 text-lg leading-8 text-gray-300">Pata Taarifa na matukio muhimu ya kusisimua kupitia kurasa zetu za Instagram.</p>
            </div>
