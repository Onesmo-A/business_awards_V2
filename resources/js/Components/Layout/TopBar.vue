...
<template>
  <div class="fixed top-0 left-0 right-0 z-50 h-10 bg-black/90 backdrop-blur-md border-b border-white/10 text-white text-sm flex items-center transition-all duration-300">
   <div class="container mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8">
  <!-- Contact Info (Always visible) -->
  <div class="flex items-center space-x-4 mt-2">
    <a href="https://wa.me/255652724557"  class="flex items-center space-x-2 hover:text-[var(--accent-primary)] transition duration-300 group">
      <PhoneIcon class="h-3 w-3 text-[var(--accent-primary)] group-hover:text-white transition"/>
      <span class="text-gray-300 group-hover:text-white text-[10px] font-medium tracking-wide">+255 652 724 557</span>
    </a>

    <a href="mailto:info@businessawards.co.tz" class="flex items-center space-x-2 hover:text-[var(--accent-primary)] transition duration-300 group">
      <EnvelopeIcon class="h-3 w-3 text-[var(--accent-primary)] group-hover:text-white transition"/>
      <span class="text-gray-300 group-hover:text-white text-[10px] font-medium tracking-wide">info@businessawards.co.tz</span>
    </a>
  </div>
      ...
      <div class="hidden md:flex items-center space-x-3 mt-2">
        <a href="#" target="_blank" class="text-gray-400 hover:text-[var(--accent-primary)] transition duration-300">
      ...
      <!-- Mobile Login Button -->
      <div class="flex md:hidden items-center mt-2">
        <Link :href="route('login')" class="px-3 py-1 text-xs font-bold text-white uppercase transition rounded bg-[var(--accent-primary)] hover:bg-red-600">
          Login
        </Link>
      </div>
    </div>
